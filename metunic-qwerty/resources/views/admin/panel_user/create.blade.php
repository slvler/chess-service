                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="name" class="form-control mb-2" placeholder="Kullanıcı Adı"  />
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">E Mail Adresi</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="email" class="form-control mb-2" placeholder="E Mail Adresi"  />
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">Kullanıcı Şifresi</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="password" class="form-control mb-2" placeholder="Kullanıcı Şifresi"  />
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">Kullanıcı Şifresi Tekrar</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="repassword" class="form-control mb-2" placeholder="Kullanıcı Şifresi Tekrar"  />
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-title">
                                                <h2>Kullanıcı Rolü Belirleme</h2>
                                            </div>
                                            <!--end::Card title-->
                                            <!--begin::Card toolbar-->
